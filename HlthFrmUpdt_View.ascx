<%@ Control Language="c#" AutoEventWireup="false" Codebehind="HlthFrmUpdt_View.ascx.cs" Inherits="CUS.ICS.HealthForm.HlthFrmUpdt_View" TargetSchema=""%>
...
<style type="text/css">
    ...
    .style3
    {
		...
		cellspacing="1" cellpadding="3"> 
			<tr>
				<th colspan="3">
					<p class="left">Health Form Update</p>
                    <p class="left">TLU ID&nbsp;&nbsp;: Enter ID number: 
...
&nbsp;&nbsp;&nbsp;
           ...
           <!--
			...
			<tr>
				...
				<asp:RegularExpressionValidator         
                        id="RegularExpressionValidator19a" runat="SERVER" 
			...
			<tr>
			    <td colspan="6">
			        What is the nature of your disability?<br />
